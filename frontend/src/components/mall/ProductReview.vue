      ...
      <div class="nav-bar">
        <div v-if="productInfo" class="container">
          <router-link to="/MallHome" style="text-decoration: none" title="官网">
            <el-image class="logo" style="width: 65px;height: 65px;margin-top: 10px;margin-right: 15px; border-radius: 10px;" :src="productInfo.productUrl"></el-image>
          </router-link>
          ...
          <el-button round style="position: absolute;right: 0; top: 28px;" @click="toBuy" type="primary">立即购买</el-button>
        </div>
      </div>
    </div>
    <div class="page-main">
