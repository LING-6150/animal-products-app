<template>
  <div class="mall-container">
    ...
    <div class="new-product">
      <div class="box-hd">
        <h2 class="new-product-title" style="width: 100%">
          新品专区
          <div style="position: absolute; top: 6px; right: 16px"></div>
        </h2>
      </div>
    ...
    <div class="product clearfix">
      <div
        ...
        :key="key"
      >
        <!-- <el-image lazy scroll-container=".mall-container" style="height: 100px;margin: 30px 0 0;width: 100%; border-radius: 5px;min-width:1325px" :src="value[0]['urlTop']"></el-image> -->
        <div class="box-hd">
